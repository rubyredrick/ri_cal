...
def dt(date_time, tzid = "US/Eastern")
  date_time = date_time.dup
  date_time.stub!(:acts_like_time?).and_return(true)
  time_zone = mock("timezone", :identifier => tzid)
  date_time.stub!(:time_zone).and_return(time_zone)
  RiCal::PropertyValue::DateTime.convert(date_time)
end
...
describe RiCal::RequiredTimezones::RequiredTimezone do
  ...
  it "should set the first_time to the first date_time added" do
    dt1 = dt(DateTime.parse("3/22/2009 10:48"))
    @it.add_datetime(dt1)
  ...
  it "should set the first_time to the earliest time added" do
    dt1 = dt(DateTime.parse("3/22/2009 10:48"))
    dt2 = dt(DateTime.parse("3/22/2009 9:00"))
    dt3 = dt(DateTime.parse("3/22/2009 10:00"))
    @it.add_datetime(dt1)
    @it.add_datetime(dt2)
    @it.add_datetime(dt3)
...
describe RiCal::RequiredTimezones do
  ...
  it "should create a RequiredTimezone for each new timezone presented" do
    @it.add_datetime(dt(DateTime.parse("3/22/2009 1:00")))
    @it.add_datetime(dt(DateTime.parse("4/16/2008 12:00"), "US/Central"))
    @it.add_datetime(dt(DateTime.parse("4/16/2008 12:00")))
