module RiCal
  module Properties
    ...
    module Todo
      ...
      # one instances of Array may be passed to this method
      def  remove_resourcess=(ruby_value)
       self.resources_property.delete(RiCal::PropertyValue::Array.convert(val))
      end
