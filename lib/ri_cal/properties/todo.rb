  ...
  module Properties
    ...
    module Todo
      ...
      def completed=(ruby_value)
        self.completed_property= RiCal::PropertyValue::DateTime.convert(ruby_value)
      end
      ...
      def completed_property_from_string(line) # :nodoc:
        @completed_property = RiCal::PropertyValue::DateTime.new(line)
      end
      ...
      def geo_property_from_string(line) # :nodoc:
        @geo_property = RiCal::PropertyValue::Geo.new(line)
      end
      ...
      def location_property_from_string(line) # :nodoc:
        @location_property = RiCal::PropertyValue::Text.new(line)
      end
      ...
      def percent_complete_property_from_string(line) # :nodoc:
        @percent_complete_property = RiCal::PropertyValue::Integer.new(line)
      end
      ...
      def priority_property_from_string(line) # :nodoc:
        @priority_property = RiCal::PropertyValue::Integer.new(line)
      end
      ...
      def due=(ruby_value)
        self.due_property= RiCal::PropertyValue::DateTime.convert(ruby_value)
      end
      ...
      def due_property_from_string(line) # :nodoc:
        @due_property = RiCal::PropertyValue::DateTime.from_separated_line(line)
      end
      ...
      def  add_exdate(ruby_value)
       self.exdate_property << RiCal::PropertyValue::OccurrenceList.convert(ruby_value)
      end
      ...
      def resources_property_from_string(line) # :nodoc:
        resources_property << RiCal::PropertyValue::Array.new(line)
      end
      ...
      def  add_rdate(ruby_value)
       self.rdate_property << RiCal::PropertyValue::OccurrenceList.convert(ruby_value)
      end
